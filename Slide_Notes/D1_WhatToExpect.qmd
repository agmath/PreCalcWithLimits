...
+ In PreCalculus, functions may transition from positive to negative at *roots* / x-intercepts or at domain restrictions.
...
## Class Embedded Tutors and Availability
...
:::{.column width="50%"}
  ...
  + Embedded Tutor: Baba Cisse
  
    + e-mail address: [baba.cisse@snhu.edu](mailto:baba.cisse@snhu.edu)
    + Drop-In Location: Library, Room 205
...
:::{.column width="50%"}
  ...
  + Embedded Tutor: Mazie Burt
    
    + e-mail address: [mazie.burt@snhu.edu](mailto:mazie.burt@snhu.edu)
    + Drop-In Location: Library, Room 205
    + Drop-In Hours (please visit!): 
...
## Grading Scheme
  ...
  Grade Item                     | Value
  -------------------------------|---------
  Participation/Exit Tickets (~20) | 10%
  Homework (~13)                 | 30%
  Exams (x4)                     | 60%
...
+ **Exams:** We'll have four exams during the semester. Unfortunately, time does not permit for us to have dedicated *review* class meetings, but I'm always happy to review with people during office hours.
    + $\bigstar$ I Need to Miss an Exam! $\bigstar$ Things come up -- you may be sick, have an emergency, or simply not feel ready to take an exam. In any of these cases, you'll notify me that you are unable to complete the exam. That exam weight will be shifted to the final exams, where you'll be required to complete the corresponding optional component of the final exam. No make-up exams will be given.
+ **Final Exams:** The final exams are optional and correspond to Exams I - IV earlier in our semester. You may complete any or all of those exams to replace earlier exam grades (with the average of the original score and the score on the corresponding final exam). If you miss an exam, then you'll be required to complete the corresponding final exam and that score will count as the entire exam grade.
...
+ The remainder of our course will be quite repetitive.
    ...
    viii. Determine whether the function is invertible.
    ix. Find the inverse of the function, if it exists.
    x. Solve equations involving expressions from that particular function class.
...
\begin{align} 5\left(2x^2 + 3x - 8\right) &= 5\left(2x^2 +3x + \left(-8\right)\right)
\end{align}
...
\begin{align} 5\left(2x^2 + 3x - 8\right)  &= \color{blue}{5}\left(2x^2 +3x + \left(-8\right)\right)\\
&= \color{blue}{5}\left(2x^2\right) + \color{blue}{5}\left(3x\right) + \color{blue}{5}\left(-8\right)
\end{align}
...
\begin{align} 5\left(2x^2 + 3x - 8\right)  &= 5\left(2x^2 +3x + \left(-8\right)\right)\\
&= 5\left(2x^2\right) + 5\left(3x\right) + 5\left(-8\right)\\
&= \boxed{~10x^2 + 15x - 40~}
\end{align}
...
\begin{align} 3x^5 - 5x^3 - 3\left(2x^3 - x^5 + 5x^4\right) &= 3x^5 - 5x^3 + \color{blue}{\left(-3\right)}\left(2x^3 + \left(-x^5\right) + 5x^4\right)
\end{align}
...
\begin{align} 3x^5 - 5x^3 - 3\left(2x^3 - x^5 + 5x^4\right) &= 3x^5 - 5x^3 + \left(-3\right)\left(2x^3 + \left(-x^5\right) + 5x^4\right)\\
&= 3x^5 - 5x^3 + \color{blue}{\left(-3\right)}\left(2x^3\right) + \color{blue}{\left(-3\right)}\left(-x^5\right) + \color{blue}{\left(-3\right)}\left(5x^4\right)\\
...
\begin{align} 2\left(3x + 4y\right) - 5\left(x - 2y\right) &= 2\left(3x + 4y\right) + \left(-5\right)\left(x + \left(-2y\right)\right)
\end{align}
...
\begin{align} 2\left(3x + 4y\right) - 5\left(x - 2y\right) &= 2\left(3x + 4y\right) + \left(-5\right)\left(x + \left(-2y\right)\right)\\
&= 2\left(3x\right) + 2\left(4y\right) + \left(-5\right)x + \left(-5\right)\left(-2y\right)
\end{align}
...
\begin{align} x^2 - 2x + 1 &\stackrel{\substack{x = 5\\ \to}}{=} \left(5\right)^2 - 2\left(5\right) + 1
\end{align}
...
&= \frac{x^2z^5y^2}{y^3\left(x^6y^2z^6\right)}\\
&= \frac{x^2z^5y^2}{x^6y^5z^6}\\
&= \frac{x^2z^5y^2}{x^2z^5y^2\left(x^4y^3z\right)}
\end{align}
...
&= \frac{x^2z^5y^2}{x^6y^5z^6}\\
&= \frac{x^2z^5y^2}{x^2z^5y^2\left(x^4y^3z\right)}\\
&= \boxed{~\frac{1}{\left(x^4y^3z\right)}~}
\end{align}

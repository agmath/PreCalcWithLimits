---
title: "MAT 142: Intervals and Introduction to Functions"
author: Dr. Gilbert
format: 
  revealjs:
    smaller: true
...
This notation is compact and informative since $f\left(x\right) = 5x + 4$ tells us exactly what happens to the input: *multiply by 5, then add 4*.

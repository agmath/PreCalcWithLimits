...
p_f <- ggplot() +
  ...
  scale_y_continuous(breaks = seq(-6, 8, by = 2), sec.axis = dup_axis()) +
...
p_g <- ggplot() +
  ...
  annotate("segment",
           ...
           linewidth = 0.5) +
  scale_x_continuous(breaks = seq(-4, 4, by = 1)) +
  scale_y_continuous(breaks = seq(-6, 12, by = 2), sec.axis = dup_axis()) +
...
pp <- ggplot() +
  ...
  scale_y_continuous(breaks = seq(-4, 4, by = 1), sec.axis = dup_axis()) +
...
pq <- ggplot() +
  ...
  annotate("segment", x = 0, xend = 0, y = -10, yend = 5,
           arrow = arrow(length = unit(0.3, "cm"), type = "closed"), linewidth = 0.5) +
  scale_x_continuous(breaks = seq(-5, 5, by = 1)) +
  scale_y_continuous(breaks = seq(-10, 4, by = 2), sec.axis = dup_axis()) +
